...
struct UnifiedSidebar: View {
    ...
    /// Tiny build identifier pinned at the bottom of the sidebar's list area
    /// (just above the bottom buttons divider). Generated by `scripts/gen-buildinfo.sh`
    /// into BuildInfo.swift.
