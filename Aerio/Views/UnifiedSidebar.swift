...
struct UnifiedSidebar: View {
    ...
    /// Tiny build identifier shown at the bottom of the folder list so it's obvious
    /// which version is running. Generated by `scripts/gen-buildinfo.sh` into BuildInfo.swift.
