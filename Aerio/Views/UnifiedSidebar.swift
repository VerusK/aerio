...
struct UnifiedSidebar: View {
    ...
    /// Tiny build identifier shown at the bottom of the sidebar so it's obvious
    /// which version is running. Generated by `scripts/run.sh` into BuildInfo.swift.
