...
description: Aerio evolved from WKWebView Gmail scraping to Gmail REST API — all scraping code deleted, no legacy remains
type: project
---

Aerio was originally built on WKWebView-based Gmail DOM scraping (JS injection, gmail_parser.js, gmail_actions.js). On 2026-03-21 it was fully migrated to Gmail REST API.
